<template>
	<div id="app" class="page-wrap">
		...
		<el-row class="top" :gutter="10">
			<el-col :span="12"><textarea v-model="old_text" @input="onInput()" placeholder="请输入要翻译的JSON数据，中文"
					class="input-textarea"></textarea></el-col>
			<el-col :span="12">
		...
		<h3 class="err-text" v-if="err_arr.length">以下文字未翻译<span>(如果所有单词都未翻译，请检查appid或key配置是否正确，或者查看F12 ->
				Network定位错误原因)</span></h3>
		...
		<el-dialog title="配置" :visible.sync="dialogFormVisible">
			...
			<div class="tips">
				<p>1、注册百度翻译开放平台账号 <a href="https://api.fanyi.baidu.com/"
						target="_blank">https://api.fanyi.baidu.com/</a>,并进行实名认证</p>
...
export default {
	...
	data () {
		return {
			...
			form: {
				appid: "20230209001555383", //百度翻译的APP ID
				key: "2eYiMQazuDaUwTPj20Y8", //百度翻译的开发者秘钥
			},
			rules: {
				appid: [
